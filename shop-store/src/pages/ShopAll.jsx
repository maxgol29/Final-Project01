    ...
    return(
        <div className='mx-8'>
            <ul>
                ...
                <li className='w-10/12 m-auto my-6 text-base font-medium hover:underline'><a href='/'>All Products</a></li>  
                ...
                <li className='w-10/12 m-auto my-6 text-base hover:underline'><a href='/mobile'>Mobile</a></li>
...
function MainPart() {
    const {headphones, speakers, phones } = products
    ...
    return(
        <div className='w-full flex flex-nowrap justify-between py-40 bg-gray-300'>
            <div className='w-[500px]'>
                ...
                <MainProducts sections={[headphones, speakers, phones]} name={'All Products'}/>
        </div>
    )
}
