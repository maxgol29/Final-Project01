    ...
    return(
        <div className='mx-8'>
            <ul>
                ...
                <li className='w-10/12 m-auto my-6 text-base hover:underline font-medium'><a href='#'>Headphones</a></li>
...
function MainPart() {
    const {headphones, speakers} = products
    ...
    return(
        <div className='w-full flex flex-nowrap justify-between py-40 bg-gray-300'>
            <div className='w-[500px]'>
                ...
                <MainProducts sections={[headphones, speakers]} name={'Audio'}/>
        </div>
    )
}
